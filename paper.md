...
[`n_hlayers()`](https://kindling.joshuamarie.com/reference/dials-kindling.md)/[`grid_depth()`](https://kindling.joshuamarie.com/reference/grid_depth.md)
and
...
[`nn_module_generator()`](https://kindling.joshuamarie.com/reference/nn_module_generator.md)/[`train_nn()`](https://kindling.joshuamarie.com/reference/gen-nn-train.md)
