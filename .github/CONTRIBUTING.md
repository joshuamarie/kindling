...
This outlines how to propose a change to kindling.
...
*   Fork the package and clone onto your computer. If you haven't done this before, we recommend using `usethis::create_from_github("joshuamarie/kindling", fork = TRUE)`.
