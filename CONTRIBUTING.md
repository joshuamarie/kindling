...
This outlines how to propose a change to kindling. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("joshuamarie/kindling", fork = TRUE)`.
...
Code of Conduct](https://kindling.joshuamarie.com/CODE_OF_CONDUCT.md).
